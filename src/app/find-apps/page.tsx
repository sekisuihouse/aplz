...
export const metadata = pageMetadata({
  title: "アプリを探す | APLZ",
  description: "APLZの公開アプリと用途別ページから、いま必要な小さなWebアプリを探せます。",
  path: "/find-apps",
  ...
  return (
    <>
      ...
      <AudienceLanding
        ...
        description="インストールせずブラウザで使える公開アプリを集めています。何を選べばよいか分からない時は、場面別のページから探せます。"
        primaryAction={{ label: "公開アプリを見る", href: "/apps" }}
        secondaryAction={{ label: "用途別に探す", href: "/use-cases" }}
        steps={[
        ...
        destinations={[
          ...
          { title: "まだないアプリを書く", description: "探しても見つからない場合は、困りごととして投稿できます。", href: "/requests/new", label: "困りごとを書く" },
        ]}
        note={{
